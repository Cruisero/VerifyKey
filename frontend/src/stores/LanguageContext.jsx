...
const translations = {
    zh: {
        ...
        guideAccount: '账号建议：',
        guideAccountDesc: '建议使用老号，新号极其容易封控，导致账号无法登录',
        guideBindCard: '绑卡注意：',
...
验证失败不消耗额度`,
        ...
        gptInsufficientCredits: '积分不足，需要 2 积分，当前剩余 {credits} 积分',
        ...
        gptResultNote: '⚠️ 请确保 ChatGPT 已登录，充值成功后扣除 2 积分',
...
Failed verification does not consume quota.`,
        ...
        gptInsufficientCredits: 'Insufficient credits. Need 2, current balance: {credits}',
        ...
        gptResultNote: '⚠️ Make sure you are logged in to ChatGPT. 2 credits will be deducted on success',
