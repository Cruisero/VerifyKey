...
const translations = {
    zh: {
        ...
        tierJioDesc: '免信用卡直接升级 <strong>18 个月 Pro</strong>',
        ...
        panelTitleJio: 'Jio 免卡升级-无需信用卡直接升级 18 个月 Pro',
...
验证失败不消耗额度`,
    ...
    en: {
        ...
        tierJioDesc: 'Direct upgrade to <strong>18 months Pro</strong> without a credit card',
        ...
        panelTitleJio: 'Jio Direct Upgrade — 18 Months Pro without Credit Card',
        tierStandardTab: '📦 Standard',
        tierProTab: '⚡ Pro',
        tierJioTab: '🎁 Jio Direct',
        singleSubmit: 'Single',
        batchSubmit: 'Batch',
        emailLabel: 'Email',
