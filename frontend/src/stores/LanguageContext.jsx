...
const translations = {
    zh: {
        ...
        tierJioDesc: '无需信用卡 <strong>直接升级</strong>（耗时约 1 分钟）',
        ...
        panelTitleJio: '极速订阅-无需信用卡直接升级（约 1 分钟）',
...
验证失败不消耗额度`,
    ...
    en: {
        ...
        tierJioDesc: 'Direct upgrade <strong>without a credit card</strong> (~1 min)',
        ...
        panelTitleJio: 'Express Subscribe — Direct Upgrade without Credit Card (~1 min)',
