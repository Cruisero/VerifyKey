...
const translations = {
    zh: {
        ...
        tierJioDesc: '无需信用卡 <strong>直接升级</strong>',
...
验证失败不消耗额度`,
    ...
    en: {
        ...
        tierJioDesc: 'Direct upgrade <strong>without a credit card</strong>',
        ...
        panelTitleJio: 'Express Verify — Direct Upgrade without Credit Card',
